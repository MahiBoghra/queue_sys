 ...
 *   Returns the current session's user profile and dashboard information.
 *   Called on page load to restore an active session without requiring a
 *   re-login.  Returns 401 if the session cookie is missing or expired.
 * @module api/auth/me
 */
